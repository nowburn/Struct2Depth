...
model_ckpt="/home/nowburn/disk/data/Struct2Depth/model/kitti/model-199160"
handle_motion="false"
size_constraint_weight="0" # This must be zero when not handling motion.

# If running on KITTI, set as follows:
data_dir='/home/nowburn/disk/data/Struct2Depth/kitti/kitti_processed2/'
triplet_list_file="$prediction_dir/test_files_eigen_triplets.txt"
triplet_list_file_remains="$prediction_dir/test_files_eigen_triplets_remains.txt"
ft_name="kitti"
