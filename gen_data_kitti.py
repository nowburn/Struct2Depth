...
""" Offline data generation for the KITTI dataset2."""
...
HEIGHT = 128
STEPSIZE = 1
INPUT_DIR = '/home/nowburn/disk/data/Struct2Depth/kitti/kitti_raw/test/'
OUTPUT_DIR = '/home/nowburn/disk/data/Struct2Depth/kitti/kitti_processed2/'
...
def gen_train_val_txt(val_size=0.1):
    with open(OUTPUT_DIR + 'train.txt', 'w') as train_f:
        with open(OUTPUT_DIR + 'val.txt', 'w') as val_f:
            for dir in os.listdir(OUTPUT_DIR):
                if len(dir.split('_')) == 7:
                    frame_list = os.listdir(os.path.join(OUTPUT_DIR, dir))
