                            ...
                            if self.size_constraint_weight > 0:
                                ...
                                def get_losses(obj_mask):
                                    ...
                                    coords = tf.where(tf.greater(  # Shape (num_true, 2=yx)
                                        obj_mask[:, :, 0], tf.constant(0.5, dtype=tf.float32)), name='coord')
                                    ...
                                    spatial_err = tf.abs(reference_pred - approx_depth,name='spatial_err')
                                    # print('=================================\n')
                                    # print('reference_pred', reference_pred)
                                    # print('approx_depth', approx_depth)
                                    # print('spatial_err', spatial_err)

                                    mean_spatial_err = tf.reduce_mean(spatial_err, name='mean_spatial_err')
